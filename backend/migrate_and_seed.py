"""
Migration and seed script for department management enhancement
Run this directly with: python -m migrate_and_seed (from backend directory)
"""
import asyncio
...
# Database URL
DATABASE_URL = "postgresql+asyncpg://lawmatcher:lawmatcher@localhost:5432/lawmatcher"
...
async def run_migration():
    ...
    async with engine.begin() as conn:
        ...
        """))
        print("OK: Added manager_name column")
        ...
        """))
        print("OK: Added department_type column")
...
async def seed_data():
    """Seed parent departments and zones"""
    engine = create_async_engine(DATABASE_URL)
    ...
    async with engine.begin() as conn:
        ...
        print(f"OK: Seeded {len(bureaus)} bureaus/special groups")
        ...
        # Update existing departments to set parent_code and department_type
        # 행정국
        ...
        print("OK: Updated existing departments with parent_code and department_type")
        ...
        print(f"OK: Created {len(neighborhoods)} neighborhood (동) records")
...
async def main():
    print("=" * 60)
    print("Department Management Enhancement - Migration & Seeding")
    print("=" * 60)
    print()
